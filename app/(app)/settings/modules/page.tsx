...
export default function ModulesSettingsPage() {
  ...
  const finishPointerDrag = (cancelled = false) => {
    ...
    const next = selectedRef.current; dragStart.current = undefined; setDragged(undefined);
